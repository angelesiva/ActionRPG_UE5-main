...
template<> FMODSTUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EFMODLogging>()
{
...
template<> FMODSTUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EFMODSpeakerMode::Type>()
{
...
template<> FMODSTUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EFMODOutput::Type>()
{
...
template<> FMODSTUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EFMODPlatforms::Type>()
{
...
template<> FMODSTUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EFMODCodec::Type>()
{
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FCustomPoolSizes); }
	static inline consteval int16 GetStructAlignment() { return alignof(FCustomPoolSizes); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FCustomPoolSizes constinit property declarations ******************
...
// ********** End ScriptStruct FCustomPoolSizes constinit property declarations ********************
...
// ********** Begin ScriptStruct FCustomPoolSizes Property Definitions *****************************
...
// ********** End ScriptStruct FCustomPoolSizes Property Definitions *******************************
...
UScriptStruct* Z_Construct_UScriptStruct_FCustomPoolSizes()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FCustomPoolSizes.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FFMODPlatformSettings); }
	static inline consteval int16 GetStructAlignment() { return alignof(FFMODPlatformSettings); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/FMODSettings.h" },
	};
...
// ********** Begin ScriptStruct FFMODPlatformSettings constinit property declarations *************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FFMODPlatformSettings constinit property declarations ***************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FFMODPlatformSettings Property Definitions ************************
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FFMODPlatformSettings_Statics::NewProp_Codecs_Key_KeyProp = { "Codecs_Key", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UEnum_FMODStudio_EFMODCodec, METADATA_PARAMS(0, nullptr) }; // 1288994641
...
// ********** End ScriptStruct FFMODPlatformSettings Property Definitions **************************
...
UScriptStruct* Z_Construct_UScriptStruct_FFMODPlatformSettings()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FFMODPlatformSettings.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FFMODProjectLocale); }
	static inline consteval int16 GetStructAlignment() { return alignof(FFMODProjectLocale); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/FMODSettings.h" },
	};
...
// ********** Begin ScriptStruct FFMODProjectLocale constinit property declarations ****************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FFMODProjectLocale constinit property declarations ******************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FFMODProjectLocale Property Definitions ***************************
...
// ********** End ScriptStruct FFMODProjectLocale Property Definitions *****************************
...
UScriptStruct* Z_Construct_UScriptStruct_FFMODProjectLocale()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FFMODProjectLocale.InnerSingleton);
}
...
// ********** Begin Class UFMODSettings constinit property declarations ****************************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UFMODSettings constinit property declarations ******************************
...
// ********** Begin Class UFMODSettings Property Definitions ***************************************
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UFMODSettings_Statics::NewProp_Locales_Inner = { "Locales", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FFMODProjectLocale, METADATA_PARAMS(0, nullptr) }; // 3849966634
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UFMODSettings_Statics::NewProp_Locales = { "Locales", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFMODSettings, Locales), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Locales_MetaData), NewProp_Locales_MetaData) }; // 3849966634
...
// ********** End Class UFMODSettings Property Definitions *****************************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UFMODSettings);
...
struct Z_CompiledInDeferFile_FID_BuildAgent1_work_c1c3f17eb167c494_build_staging_FMODStudio_HostProject_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h__Script_FMODStudio_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EFMODLogging_StaticEnum, TEXT("EFMODLogging"), &Z_Registration_Info_UEnum_EFMODLogging, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2059363024U) },
		{ EFMODSpeakerMode_StaticEnum, TEXT("EFMODSpeakerMode"), &Z_Registration_Info_UEnum_EFMODSpeakerMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 204769570U) },
		{ EFMODOutput_StaticEnum, TEXT("EFMODOutput"), &Z_Registration_Info_UEnum_EFMODOutput, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4174697901U) },
		{ EFMODPlatforms_StaticEnum, TEXT("EFMODPlatforms"), &Z_Registration_Info_UEnum_EFMODPlatforms, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1059900686U) },
		{ EFMODCodec_StaticEnum, TEXT("EFMODCodec"), &Z_Registration_Info_UEnum_EFMODCodec, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1288994641U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FCustomPoolSizes::StaticStruct, Z_Construct_UScriptStruct_FCustomPoolSizes_Statics::NewStructOps, TEXT("CustomPoolSizes"),&Z_Registration_Info_UScriptStruct_FCustomPoolSizes, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCustomPoolSizes), 3552791989U) },
		{ FFMODPlatformSettings::StaticStruct, Z_Construct_UScriptStruct_FFMODPlatformSettings_Statics::NewStructOps, TEXT("FMODPlatformSettings"),&Z_Registration_Info_UScriptStruct_FFMODPlatformSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFMODPlatformSettings), 2571153647U) },
		{ FFMODProjectLocale::StaticStruct, Z_Construct_UScriptStruct_FFMODProjectLocale_Statics::NewStructOps, TEXT("FMODProjectLocale"),&Z_Registration_Info_UScriptStruct_FFMODProjectLocale, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFMODProjectLocale), 3849966634U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UFMODSettings, UFMODSettings::StaticClass, TEXT("UFMODSettings"), &Z_Registration_Info_UClass_UFMODSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFMODSettings), 1146996648U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BuildAgent1_work_c1c3f17eb167c494_build_staging_FMODStudio_HostProject_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h__Script_FMODStudio_2622463244{
